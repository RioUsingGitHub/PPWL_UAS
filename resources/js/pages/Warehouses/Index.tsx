            ...
            <div className="mx-auto max-w-7xl px-4 py-2 sm:px-6 lg:px-8">
                <div className="mb-4 flex items-center justify-between bg-white px-4 py-4 shadow sm:rounded-xl">
                    <form onSubmit={handleFilter} className="flex space-x-2">
                        ...
                        <button
                            type="submit"
                            className="inline-flex h-[40px] min-w-[80px] items-center justify-center rounded-md bg-green-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all duration-200 hover:scale-105 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none"
                        >
                            Filter
                        </button>
                    </form>
                    ...
                    <div className="flex space-x-3">
                        <button
                            onClick={openCreate}
                            className="inline-flex h-[40px] min-w-[140px] items-center justify-center rounded-md bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all duration-200 hover:scale-105 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
                        >
                            Add Warehouse
                        </button>
                        <button
                            ...
                            className="inline-flex h-[40px] min-w-[140px] items-center justify-center rounded-md bg-purple-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all duration-200 hover:scale-105 hover:bg-purple-600 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none"
                        >
                            Manage Locations
                        </button>
                    </div>
                ...
                <div className="mt-4 flex justify-center space-x-1">
                    {warehouses?.links?.map((link, i) => (
                        <Link
                            key={i}
                            href={link.url || '#'}
                            className={`inline-flex h-[40px] min-w-[40px] items-center justify-center rounded border px-3 py-2 text-sm font-medium transition-colors duration-200 ${link.active ? 'border-blue-500 bg-blue-500 text-white' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'
                                }`}
                ...
                <Transition appear show={isLocationManagementOpen} as={Fragment}>
                    <Dialog as="div" className="relative z-10" onClose={closeLocationManagement}>
                        <Transition.Child
                            as={Fragment}
                            enter="ease-out duration-300"
                            enterFrom="opacity-0"
